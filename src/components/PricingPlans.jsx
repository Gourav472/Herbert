...
const PricingPlans = () => {
    return (
        <div className='py-16 sm:py-20 bg-offOrange relative'>
                ...
                <div className='flex flex-col items-center relative'>
                    ...
                    <div className="flex max-lg:flex-wrap max-lg:justify-center max-sm:gap-16 sm:gap-7 md:gap-12 xl:gap-[54px] pt-8 sm:pt-12 md:pt-14">
                        {PRICING_PLANS_DATA.map((items, index) => (
                            <div key={index} className={`flex max-sm:max-w-[327px] z-20 sm:max-w-[260px] md:max-w-[290px] lg:max-w-[308px] w-full flex-col ${index === 1 ? "xl:px-[54px] max-sm:border-x-0 max-lg:border-e-0 sm:ps-7 md:ps-10 lg:px-12 max-sm:max-w-[327px] sm:max-w-[288px] md:max-w-[330px] lg:!max-w-[416px] border-x-[1px] border-mediumGray" : ""}`}>
