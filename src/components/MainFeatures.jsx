...
const MainFeatures = () => {
    return (
        <div className='max-sm:pb-20 sm:pb-24 md:pb-28 lg:pb-[120px] relative'>
            <div className='container relative z-30'>
                <div className='flex md:h-[238px] max-md:flex-wrap max-md:justify-center md:items-center gap-6 max-sm:mt-4 sm:mt-7 md:mt-12 lg:mt-0 max-lg:mb-20 lg:translate-y-[-112px]'>
                    {FEATURES_CARDS_DATA.map((items, index) => (
                        <div key={index} className='px-5 flex flex-col border md:max-h-[196px] md:hover:max-h-[238px] md:hover:py-[40px] bg-white border-gray rounded-lg max-sm:max-w-[327px] max-sm:py-[22px] sm:max-w-[288px] md:max-w-[364px] duration-300 ease-linear w-full hover:border-transparent hover:shadow-4xl py-5 items-center'>
                ...
                <div className='flex justify-between max-lg:flex-wrap max-lg:justify-center gap-6 lg:gap-4 xl:gap-0 max-sm:pt-6 sm:pt-9 md:pt-12 pt-14'>
                    <div className='lg:hidden max-lg:max-w-[500px] w-full flex justify-center'>
                        <img className='max-sm:max-w-[286px] pointer-events-none lg:hidden sm:max-w-[300px]' src={featuresImage} alt="tourism" />
                    </div>
