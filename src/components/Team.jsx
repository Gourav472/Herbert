...
const Team = () => {
    return (
        <div id='about' className='xl:pt-[283px] bg-team-bg bg-full bg-no-repeat bg-top pt-16 pb-[79px] sm:py-24 md:py-36 lg:py-52 xl:pb-[267px] xl:max-w-[1920px] xl:mx-auto relative'>
            <div className='container relative z-20'>
                <div className='flex justify-between max-lg:flex-wrap max-lg:flex-col-reverse sm:items-center gap-6'>
                    <div className='lg:pt-0 flex sm:items-center lg:items-start flex-col'>
                        ...
                        <img className='max-w-[261px] w-full mt-[35px] mx-auto lg:hidden' src={manRight} alt="hello" />
