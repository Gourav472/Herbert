        ...
        <div id='services' className='relative xl:max-w-[1920px] xl:mx-auto'>
            <div className='container relative z-20'>
                <div className='flex flex-col items-center'>
                    <h2 ref={headingRef} className='font-rubik overflow-hidden text-offBlack capitalize max-sm:text-[22px] max-sm:leading-7 font-semibold sm:text-2xl sm:leading-8 md:leading-9 md:text-3xl lg:text-5xl lg:leading-[56.88px] text-center sm:text-nowrap'>
                        Frequently Asked <span className='font-rubik max-sm:!overflow-hidden sm:!inline text-darkRed'>Questions</span>
                    </h2>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="float-right z-30">
                                            <svg className={`${activeIndex === index ? "transform rotate-180 hidden" : ""} max-sm:w-[20px] max-sm:h-[20px] sm:w-[24px] md:h-[24px]`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <svg className={`${activeIndex === index ? "block" : "hidden"} max-sm:w-[20px] max-sm:h-[20px] sm:w-[24px] md:h-[24px]`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
