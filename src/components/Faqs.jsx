                ...
                <div className='row flex flex-wrap flex-row -mx-3 pt-4 sm:pt-10 max-sm:pb-8 sm:pb-12'>
                    {FAQS.map((faq, index) => (
                        <div key={index} className='w-full lg:w-6/12 px-3'>
                            <div className={`overflow-hidden ease-linear rounded-lg ${activeIndex === index ? "z-30 border-transparent shadow-4xl" : "border-[1px] border-lightGray"} max-sm:mt-4 sm:mt-6`}>
                                <button
